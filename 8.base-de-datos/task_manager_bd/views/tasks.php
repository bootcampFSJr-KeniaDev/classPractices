            ...
            <tbody>
                <?php foreach($tasks as $task){ ?>
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editarModal<?php echo $task['id_task']; ?>">Editar</button>
                        </td>
                        <td><button class="btn btn-danger">Cambiar Estado</button></td>
                    </tr>

                    <!-- Modal para editar tareas -->
                    <div class="modal fade" id="editarModal<?php echo $task['id_task']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
